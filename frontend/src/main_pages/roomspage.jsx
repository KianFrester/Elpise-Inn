...
const RoomsPage = () => {
  ...
  const rooms = [
    ...
    },
    {
      ...
      description:
        "Spacious accommodations ideal for families and groups wanting a comfortable stay.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Elegant rooms with breathtaking ocean views and premium amenities for a luxurious experience.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Designed for friend groups with multiple beds and a social space perfect for bonding.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Our premium suite offering the ultimate luxury experience with separate living areas and exclusive amenities.",
      longDescription:
    ...
    },
    {
      ...
      description:
        "Secluded villas surrounded by lush tropical gardens offering privacy and tranquility.",
      longDescription:
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1605346434674-a440ca4dc4c0?auto=format&fit=crop&q=80&w=1000",
      description:
        "Romantic suite specially designed for couples with intimate settings and romantic touches.",
      longDescription:
        "Celebrate your love in our specially designed Honeymoon Suite. This romantic haven features thoughtful touches to create an intimate atmosphere for couples. From the luxurious king-size bed and private balcony to special amenities and services, every detail has been carefully considered to enhance your romantic getaway.",
      features: [
        "Four-poster bed",
        "Private balcony",
        "Champagne service",
      ...
      <div className="py-5 px-4 md:px-[5%] lg:px-[10%] bg-gray-50">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12 text-lg">
            Discover our range of accommodations designed to provide comfort,
            luxury, and an authentic island experience for every type of
            traveler.
          </p>
                ...
                <div className="p-5 flex-grow flex flex-col">
                  ...
                  <ul className="mb-6 flex-grow">
                    {room.features.map((feature, index) => (
                      <li
                        key={index}
                        className="mb-2 flex items-center text-gray-600 text-[0.95rem]"
                      >
          ...
          <div className="text-center mt-16">
            <h3 className="text-2xl text-gray-800 mb-6 font-playfair">
              Looking for group accommodation?
            </h3>
            <p className="text-gray-600 max-w-2xl mx-auto mb-8">
              For special events, retreats, or large group bookings, please
              contact our reservations team directly for customized options and
              special rates.
            </p>
            <Link to ="/bookingpage"
